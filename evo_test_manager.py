...
class EvoTestManager:
    ...
    def __init__(self, config_path='evo_test_manager.yaml'):
        ...
        self.image = "rocket-image-atour-proposal-roulette"
        ...
        self.main_hostname_prefix = "AMG_ProposalRoulette"
    ...
    def main(self):
        ...
        for idx in range(1, self.generations):
            ...
            population = tools.selRoulette(population + offspring, k=self.population_size)

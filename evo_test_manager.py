...
class EvoTestManager:
    ...
    def __init__(self, config_path='evo_test_manager.yaml'):
        ...
        self.image = "rocket-image-atour-proposal-tournament"
        ...
        self.main_hostname_prefix = "AMG_ProposalTournament"
    ...
    def main(self):
        ...
        for idx in range(1, self.generations):
            ...
            population = tools.selTournament(population + offspring, k=self.population_size, tournsize=4)

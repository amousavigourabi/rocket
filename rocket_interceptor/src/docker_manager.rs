...
impl DockerNetwork {
    ...
    async fn download_image(&mut self) {
        let image = env::var("ROCKET_XRPLD_DOCKER_CONTAINER").unwrap_or("ghcr.io/amousavigourabi/docker-rippled/seeded-2.4.0-lower-agreement-threshold:latest".to_string());
        self.docker
            .create_image(
